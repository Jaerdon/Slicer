...
namespace Slicer
{
    public static class SlicerProject
    {
        ...
        {
            Console.WriteLine(
                $"Usage: {Path.GetFileName(Assembly.GetEntryAssembly().Location)} [OPTION]... [FILE]...\n" +
        ...
        {
            Console.WriteLine(
                $"Improper arguments.\nTry '{Path.GetFileName(Assembly.GetEntryAssembly().Location)} --help' for more information.");
        }
    }
}